			...
			array(
				...
				'items'=>array(
					...
					array('label'=>'API', 'url'=>'#', 'items'=>array(
						array('label'=>'Get All Events', 'url'=>Yii::app()->createUrl('api/events')),
						array('label'=>'Get All Talks', 'url'=>Yii::app()->createUrl('api/talks')),
						array('label'=>'Get All Comments', 'url'=>Yii::app()->createUrl('api/comments')),
						array('label'=>'Get All Users', 'url'=>Yii::app()->createUrl('api/users')),
						'---',
						array('label'=>'Consume BdEventsApi', 'url'=>Yii::app()->createUrl('bdeventsapi/consume/events'), 'visible' => !Yii::app()->user->isGuest),
					)),
				),
			),
		),
